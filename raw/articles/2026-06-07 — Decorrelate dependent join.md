...
---
## For future Claude
This is a raw source note covering the topic of Decorrelate dependent join.

# Decorrelate dependent join
Created: 2024-11-09

## Undestand correlated subqueries
![[raw/assets/Decorrelate_dependent_join-diagram-1.png]]
...
```
is "a.id"
![[raw/assets/Decorrelate_dependent_join-diagram-2.png]]
...
## Group by
![[raw/assets/Decorrelate_dependent_join-diagram-3.png]]
...
```
### General unnesting
![[raw/assets/Decorrelate_dependent_join-diagram-4.png]]
...
## Major point
![[raw/assets/Decorrelate_dependent_join-diagram-5.png]]
